...
bool MapFrame::canSelectEntitiesWithSameClassname() const
{
  ...
  return kdl::vec_contains(nodes.brushes(), [](const mdl::BrushNode* brushNode) -> bool {
    ...
    const std::string* classname =
      parentEnt->entity().property(mdl::EntityPropertyKeys::Classname);
    ...
    return classname && *classname != mdl::EntityPropertyValues::WorldspawnClassname;
  });
}
